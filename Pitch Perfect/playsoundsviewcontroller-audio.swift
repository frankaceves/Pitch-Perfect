...
extension PlaySoundsViewController: AVAudioPlayerDelegate {
    ...
    func playSound(rate: Float? = nil, pitch: Float? = nil, echo: Bool = false, reverb: Bool = false) {
        ...
        // MARK: HOW DO WE EXTEND LENGTH OF ECHO?
        // node for echo
        /*let echoNode = AVAudioUnitDistortion()
        echoNode.loadFactoryPreset(.multiEcho2)
        echoNode.preGain = -2.0
        echoNode.wetDryMix = 50
        audioEngine.attach(echoNode)
         */
        //MARK: ALT ECHO EFFECT that I chose to use.
        let echoNode = AVAudioUnitDelay()
        echoNode.delayTime = 0.50
        echoNode.feedback = 70
        ...
        reverbNode.wetDryMix = 40 // was 50
...
// MARK: CHECK HERE FOR OBJC FUNC DUE TO SWIFT 4 MIGRATION
    @objc func stopAudio() {
